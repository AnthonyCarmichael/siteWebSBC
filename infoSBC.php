        ...
        <section class="flex wrap">
            <?php foreach ($SBCObjArray as $SBCObj) { ?>
                <article class="col-4">
                    ...
                    <div>
                        <p><?= $SBCObj->get_marqueSBC() . ' ' . $SBCObj->get_modeleSBC() . ' ' . $SBCObj->get_RAM() . ' Go ' . $SBCObj->get_longueur() . ' par ' . $SBCObj->get_largeur() . ' mm'; ?>
                        </p>
                        <p>Processeur
    ...
    <section class="flex wrap">
        <?php foreach ($SBCs as $SBC) { ?>
            <article class="col-4">
                ...
                <div>
                    <p><?= $SBC->get_marqueSBC() . ' ' . $SBC->get_modeleSBC() . ' ' . $SBC->get_RAM() . ' Go ' . $SBC->get_longueur() . ' par ' . $SBC->get_largeur() . ' mm'; ?>
                    </p>
                    <p>Processeur
